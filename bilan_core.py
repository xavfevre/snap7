...
# ---------------------------------------------------------------------------
# Géocodage (BAN) + Itinéraire (ORS / OSRM / haversine)
# ---------------------------------------------------------------------------
class GeoService:
...
# ---------------------------------------------------------------------------
# Trackdéchets : récupération des BSDD
# ---------------------------------------------------------------------------
FORMS_QUERY = """
...
# ---------------------------------------------------------------------------
# Extraction des trajets impliquant PROTEC
# ---------------------------------------------------------------------------
...
def compute_bilan(forms, cfg, geo, target_years, logger=print, progress=None):
    ...
    for form, leg in legs_all:
        ...
        rows.append({
            "BSD": form.get("readableId", ""),
            "Annee": leg["year"],
            "Type": leg["type"],
            "Categorie": cat,
            "CED": leg["ced"],
            "Origine": leg["origin_label"],
            "Adresse origine": o_addr,
            "Destination": leg["dest_label"],
            "Adresse destination": d_addr,
...
# ---------------------------------------------------------------------------
# Utilitaire : parse une chaîne d'années ("2025" ou "2023-2025")
# ---------------------------------------------------------------------------
def parse_years(txt):
    years = set()
